...
export default function Home() {
  const links = [
    { href: `/join/${DEMO_BUSINESS_ID}`, emoji: "📱", title: "Customer signup", desc: "Scan-to-join page where clients become VIP members." },
    { href: "/owner", emoji: "💼", title: "Owner app", desc: "Members, scan-to-log a visit, bookings & messaging." },
    { href: "/admin", emoji: "👑", title: "Admin console", desc: "Platform view across every business." },
  ];
  return (
    <main className="mx-auto max-w-3xl px-5 py-16">
      ...
      <p className="mt-10 text-xs text-ink-soft">
        Running on the built-in demo data. Add Supabase &amp; Twilio keys in{" "}
