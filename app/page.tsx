...
import {
  CalendarIcon, MembersIcon, MessageIcon, CheckIcon, HomeIcon, ScanIcon,
...
const ACCESS = [
  {
    href: `/join/${DEMO_BUSINESS_ID}`,
    title: "Client Join Page",
    desc: "Clients join through a branded signup page, give SMS consent, and receive their VIP profile.",
    cta: "Open join page",
  },
  {
    href: "/login",
    title: "Owner Dashboard",
    desc: "Manage clients, appointments, visits, rewards, messages, referrals, and retention performance.",
    cta: "Sign in",
  },
  {
    href: "/login",
    title: "Platform Admin",
    desc: "Manage businesses, users, subscriptions, system settings, and platform-level data.",
    cta: "Sign in",
  },
];
    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          <div className="pointer-events-none absolute inset-0" style={{ background: "radial-gradient(circle at 50% -10%, #FCE6E9 0%, transparent 60%)" }} />
